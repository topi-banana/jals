...
pub use manifest::{
    Bin, Build, BuildScript, Dependency, DependencyError, Feature, FeatureSet, FrontendKind,
    GitDependency, GitRef, JarDependency, Manifest, ManifestParseError, Package, PathDependency,
    Run, ValidationError,
};
