...
pub struct IntellijJavadoc {
    ...
    #[serde(rename = "CLASS_NAMES_IN_JAVADOC", deserialize_with = "Kv::opt_number")]
    ...
    #[serde(rename = "JD_ALIGN_PARAM_COMMENTS", deserialize_with = "Kv::opt_bool")]
    ...
    #[serde(rename = "JD_KEEP_EMPTY_EXCEPTION", deserialize_with = "Kv::opt_bool")]
    ...
    #[serde(rename = "JD_KEEP_EMPTY_LINES", deserialize_with = "Kv::opt_bool")]
    ...
    #[serde(rename = "JD_KEEP_EMPTY_PARAMETER", deserialize_with = "Kv::opt_bool")]
    ...
    #[serde(rename = "JD_KEEP_EMPTY_RETURN", deserialize_with = "Kv::opt_bool")]
    ...
    #[serde(rename = "JD_KEEP_INVALID_TAGS", deserialize_with = "Kv::opt_bool")]
    ...
    #[serde(rename = "JD_PRESERVE_LINE_FEEDS", deserialize_with = "Kv::opt_bool")]
    ...
    #[serde(rename = "JD_P_AT_EMPTY_LINES", deserialize_with = "Kv::opt_bool")]
