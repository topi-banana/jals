...
pub struct IntellijCommon {
    ...
    #[serde(rename = "BLOCK_COMMENT_ADD_SPACE", deserialize_with = "Kv::opt_bool")]
    ...
    #[serde(rename = "LINE_COMMENT_ADD_SPACE", deserialize_with = "Kv::opt_bool")]
    ...
    #[serde(rename = "RIGHT_MARGIN", deserialize_with = "Kv::opt_number")]
