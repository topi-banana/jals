...
pub struct IntellijCodegen {
    ...
    #[serde(rename = "REPEAT_ANNOTATIONS", deserialize_with = "serde_kv::opt_list")]
    ...
    #[serde(rename = "REPLACE_NULL_CHECK", deserialize_with = "serde_kv::opt_bool")]
    ...
    #[serde(rename = "REPLACE_SUM", deserialize_with = "serde_kv::opt_bool")]
    ...
    #[serde(
        rename = "USE_EXTERNAL_ANNOTATIONS",
        deserialize_with = "serde_kv::opt_bool"
    )]
