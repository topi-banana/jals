...
pub struct IntellijImports {
    ...
    #[serde(rename = "PRESERVE_MODULE_IMPORTS", deserialize_with = "Kv::opt_bool")]
    ...
    #[serde(rename = "USE_FQ_CLASS_NAMES", deserialize_with = "Kv::opt_bool")]
    ...
    #[serde(rename = "USE_SINGLE_CLASS_IMPORTS", deserialize_with = "Kv::opt_bool")]
