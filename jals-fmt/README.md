...
`} finally` / `} while` continuations (`control_brace_style`) — and empty-declaration-body
collapse is configurable (`empty_item_single_line`) — see
...
`empty_item_single_line` — comment reflow — `comment-width`
