...
//!
//! Most of the bindings are pure — a bit cast, a decimal rendering, a decimal parse — and need
//! nothing from anybody. The ones that write text, and the pair that reads a clock, are not
