...
pub enum CompileFailure {
    ...
    /// against the platform package rather than a classpath, which is where the class hierarchy a
...
impl Compile {
    ...
    pub async fn workspace(
        ...
        let request = BackendRequest {
            progress: &jals_progress::Progress::SILENT,
            tree: &sources,
            // The in-process compiler reads library signatures from the platform package rather than
...
mod tests {
    ...
    fn platform() -> PackageSelection {
        PackageSelection::of([jals_platform::JavaBase::package(std::rc::Rc::new(
