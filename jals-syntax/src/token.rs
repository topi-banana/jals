...
impl TokenKind {
    ...
    pub(crate) fn keyword_kind(text: &str) -> Option<Self> {
        use TokenKind::{
            ...
            IMPLEMENTS_KW, IMPORT_KW, INSTANCEOF_KW, INT_KW, INTERFACE_KW, LONG_KW, NATIVE_KW,
            NEW_KW, NULL_KW, PACKAGE_KW, PRIVATE_KW, PROTECTED_KW, PUBLIC_KW, RETURN_KW, SHORT_KW,
            STATIC_KW, STRICTFP_KW, SUPER_KW, SWITCH_KW, SYNCHRONIZED_KW, THIS_KW, THROW_KW,
            THROWS_KW, TRANSIENT_KW, TRUE_KW, TRY_KW, VOID_KW, VOLATILE_KW, WHILE_KW,
        };
        let kind = match text {
