...
- Crate graph: `jals-cli` → `{jals-fmt, jals-lint, jals-lsp, jals-build, jals-config, jals-hir, jals-classpath, jals-fs, jals-syntax}`;
  ...
  `jals-lint` → `{jals-config, jals-hir, jals-syntax}`; `jals-hir` → `{jals-syntax, jals-classfile}`;
